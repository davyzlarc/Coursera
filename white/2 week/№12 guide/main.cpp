...
//последовательность пар вида country / capital, описывающую столицы всех стран, если в мире уже есть хот€ бы одна страна.
//ѕри выводе последовательности пары указанного вида необходимо упор€дочить по названию страны и раздел€ть между собой пробелом.
//
//ѕример 1:
//¬вод
//6
